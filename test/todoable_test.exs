defmodule TodoableTest do
  ...
  test "requests all lists", state do
    assert Todoable.lists(state.client) == {:ok, [%Todoable.List{id: "123-abc", name: "Urgent Things", src: "http://localhost:4000/api/lists/123-abc", items: :not_loaded}, %Todoable.List{id: "456-def", name: "Shopping List", src: "http://localhost:4000/api/lists/456-def", items: :not_loaded}]}
  end
  ...
  test "requests a single list with List struct", state do
    assert Todoable.get_list(state.client, %Todoable.List{id: "123-abc"}) == {:ok, %Todoable.List{id: "123-abc", name: "Urgent Things", src: "http://localhost:4000/api/lists/123-abc", items: [%Todoable.Item{finished_at: nil, id: "987-zyx", list_id: "123-abc", name: "Milk", src: "http://localhost:4000/api/lists/123-abc/items/987-zyx"}, %Todoable.Item{finished_at: "2018-01-02", id: "654-wvu", list_id: "123-abc", name: "Bread", src: "http://localhost:4000/api/lists/456-def/items/654-wvu"}]}}
  end
  ...
  test "creates a list", state do
    assert Todoable.create_list(state.client, name: "Shopping") == {:ok, %Todoable.List{id: "123-abc", name: "Urgent Things", src: "http://localhost:4000/api/lists/123-abc", items: :not_loaded}}
  end
  ...
  test "updates list", state do
    assert Todoable.update_list(state.client, id: "123-abc", name: "Groceries") == {:ok, %Todoable.List{id: "123-abc", name: "Urgent Things", src: "http://localhost:4000/api/lists/123-abc", items: :not_loaded}}
  end

  test "updates list with List struct", state do
    assert Todoable.update_list(state.client, %Todoable.List{id: "123-abc", name: "Groceries"}) == {:ok, %Todoable.List{id: "123-abc", name: "Urgent Things", src: "http://localhost:4000/api/lists/123-abc", items: :not_loaded}}
  end
  ...
  test "creates an item with List struct", state do
    assert Todoable.create_item(state.client, %Todoable.List{id: "123-abc"}, name: "Milk") == {:ok, %Todoable.Item{finished_at: nil, id: "987-zyx", name: "Milk", src: "http://localhost:4000/api/lists/123-abc/items/987-zyx", list_id: "123-abc"}}
  end
  ...
  test "deletes an item with Item struct", state do
    assert Todoable.delete_item(state.client, %Todoable.Item{list_id: "123-abc", id: "987-zyx"}) == {:ok, ""}
  end
  ...
  test "finishes an item", state do
    assert Todoable.finish_item(state.client, list_id: "456-def", item_id: "654-wvu") == {:ok, %Todoable.Item{finished_at: "2018-01-02", id: "654-wvu", name: "Bread", src: "http://localhost:4000/api/lists/456-def/items/654-wvu", list_id: "456-def"}}
  end

  test "finishes an item with Item struct", state do
    assert Todoable.finish_item(state.client, %Todoable.Item{list_id: "456-def", id: "654-wvu"}) == {:ok, %Todoable.Item{finished_at: "2018-01-02", id: "654-wvu", name: "Bread", src: "http://localhost:4000/api/lists/456-def/items/654-wvu", list_id: "456-def"}}
  end
